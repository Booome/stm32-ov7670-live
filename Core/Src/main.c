...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, OV7670_FIFO_RCK_Pin|OV7670_PWDN_Pin|OV7670_FIFO_WR_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OV7670_SCL_Pin|OV7670_RESET_Pin|OV7670_FIFO_RRST_Pin|OV7670_FIFO_WRST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : OV7670_FIFO_RCK_Pin OV7670_PWDN_Pin OV7670_RESET_Pin OV7670_FIFO_WR_EN_Pin
                           OV7670_FIFO_RRST_Pin OV7670_FIFO_WRST_Pin */
  GPIO_InitStruct.Pin = OV7670_FIFO_RCK_Pin|OV7670_PWDN_Pin|OV7670_RESET_Pin|OV7670_FIFO_WR_EN_Pin
                          |OV7670_FIFO_RRST_Pin|OV7670_FIFO_WRST_Pin;
  ...
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(OV7670_FIFO_OE_GPIO_Port, &GPIO_InitStruct);
